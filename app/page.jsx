...
export default function Home() {
  return (
    <main>
      <h2>Dashboard</h2>
      <p>
      This app creatively addresses the management of tasks or 'tickets,' each representing an actionable item. Utilizing Next.js, it displays these tickets as cards, enhancing user experience. Furthermore, it features a JSON-server backend, ensuring straightforward data handling and manipulation, including functionalities like deleting specific tickets, making it efficient and user-friendly.
      </p>
